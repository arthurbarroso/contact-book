...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26288 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26288(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26289 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26289(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26303 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26303(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26311 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26311(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26312 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26312(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26321 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26321(reader);
}
});
...
var G__26359 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26360 = s.append(c);
c = G__26359;
s = G__26360;
continue;
}
